...
Chrome
========
1- InnoVision.crx file is used only for Test case debugging. Drag and drop .crx file on chrome browser is not supported.
2- launch this link "https://chrome.google.com/webstore/detail/NewVision-intelligent-tes/eghfogfdhadandcigjcccdfhlohcgljn" in chrome and click on "Add to Chrome"

CITS IE Add-on
================

1- Download the latest release from this GitHub link "https://github.com/NewVisionQAHub/InnoVision-IE-Toolbar/releases" and install
...
1-Launch InnoVision and open either Spy,Heal or Recorder.
