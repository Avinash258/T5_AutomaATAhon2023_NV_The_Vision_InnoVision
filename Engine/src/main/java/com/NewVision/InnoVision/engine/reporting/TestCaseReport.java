 ...
 */
package com.NewVision.InnoVision.engine.reporting;
...
import com.NewVision.InnoVision.engine.constants.AppResourcePath;
...
import com.NewVision.InnoVision.engine.drivers.SeleniumDriver;
import com.NewVision.InnoVision.engine.reporting.impl.handlers.PrimaryHandler;
import com.NewVision.InnoVision.engine.reporting.impl.handlers.TestCaseHandler;
import com.NewVision.InnoVision.engine.reporting.impl.html.HtmlTestCaseHandler;
import com.NewVision.InnoVision.engine.reporting.intf.Report;
import com.NewVision.InnoVision.engine.reporting.util.DateTimeUtils;
import com.NewVision.InnoVision.engine.support.Status;
import com.NewVision.InnoVision.engine.support.Step;
import com.NewVision.InnoVision.engine.support.methodInf.MethodInfoManager;
import com.NewVision.InnoVision.engine.reporting.impl.azure.AzureTestCaseHandler;
import com.NewVision.InnoVision.engine.reporting.impl.rp.RPTestCaseHandler;
import com.NewVision.InnoVision.engine.reporting.impl.extent.ExtentTestCaseHandler;
...
//</editor-fold>
    ...
    public void updateTestLog(String stepName, String stepDescription, Status state,
       ...
       // System.out.println("Avinash");
        String stepInfo = stepLevelLog(String.valueOf(getStep().StepNum),getStep().ObjectName,getStep().Action,i,getStep().Condition,state,stepDescription);
...
//</editor-fold>
    ...
    String runInfo="Run Information" +"\n"
            + "========================"+"\n"
            + "NewVision.intelligent.test.scripter.engine :  "+ SystemDefaults.getBuildVersion()+"\n"
...
//            + String.format("[%s]   | %s", state, stepDesc)+"\n";
    String stepInfo= String.format("\n%99s\n", "=").replace(" ", "=") +"\n"+ "Step:"+String.valueOf(getStep().StepNum)+"  |  Object:"+getStep().ObjectName+"  |  Action:"+getStep().Action+"  |  Input: " +i+ "  |  Condition:"+getStep().Condition+"  | @"+DateTimeUtils.DateTimeNow() +"\n"
            + String.format("[%s]   | %s", state, stepDesc)+"\n";
    return stepInfo;
    }
