 ...
 */
package com.NewVision.InnoVision.engine.reporting.performance.har;
...
public final class Entry extends JSONObject {
    ...
    private static final Logger LOG = Logger.getLogger(com.NewVision.InnoVision.engine.reporting.performance.har.Entry.class.getName());
