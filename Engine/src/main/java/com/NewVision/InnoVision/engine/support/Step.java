 ...
 */
package com.NewVision.InnoVision.engine.support;
...
public class Step {
    ...
    public Step printStep() {
        //System.out.println(String.format("Step:%-4s| Object: %s | Action: %s | Input: %s | Conditon: %s | @%s",new Object[]{StepNum, ObjectName, Action, i, Condition, DateTimeUtils.DateTimeNow()}));
        System.out.println(String.format("Step:%-4s| Object: %s | Action: %s | Input:%s  | Conditon: %s | @%s",new Object[]{StepNum, ObjectName, Action, "*********", Condition, DateTimeUtils.DateTimeNow()}));
