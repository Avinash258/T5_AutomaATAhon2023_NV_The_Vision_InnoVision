...
public class Har<K, V> extends JSONObject {
    ...
    public void addEntry(com.NewVision.InnoVision.engine.reporting.performance.har.Entry e) {
        log.entries.add(e);
    }
    
    private com.NewVision.InnoVision.engine.reporting.performance.har.Entry getPageEntry(Page p) {
        return new com.NewVision.InnoVision.engine.reporting.performance.har.Entry(p);
    }
