 ...
 */
package com.NewVision.InnoVision.engine.reporting.impl.slack;
...
import com.NewVision.InnoVision.notification.slack.Slack;
import java.io.File;
...
public class SlackSummaryHandler extends SummaryHandler implements PrimaryHandler {
    ...
    private static JSONObject common() {
        ...
        commonData.put("text", "*InnoVision Run Report*");
