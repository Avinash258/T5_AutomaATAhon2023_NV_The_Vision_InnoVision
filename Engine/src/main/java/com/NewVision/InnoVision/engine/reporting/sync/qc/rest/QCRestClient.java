 ...
 */
package com.NewVision.InnoVision.engine.reporting.sync.qc.rest;

import com.NewVision.InnoVision.engine.reporting.sync.qc.rest.util.Q;
import com.NewVision.InnoVision.engine.reporting.sync.qc.rest.util.ServerException;
import com.NewVision.InnoVision.engine.reporting.sync.qc.rest.util.XML;
import com.NewVision.InnoVision.engine.reporting.sync.qc.rest.util.XML.BY;
import com.NewVision.InnoVision.engine.support.DLogger;
import java.io.File;
